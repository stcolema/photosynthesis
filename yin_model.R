...
# Indices for subgroups
select_A1 <- ACI1_final$TREAT == "A1"
select_A2 <- ACI1_final$TREAT == "A2"

select_AD <- ACI1_final$SIDE == "AD"
select_AB <- ACI1_final$SIDE == "AB"
select_ADAB <- ACI1_final$SIDE == "ADAB"

select_A1_AD <- as.logical((ACI1_final$TREAT == "A1") * (ACI1_final$SIDE == "AD"))
select_A1_AB <- as.logical((ACI1_final$TREAT == "A1") * (ACI1_final$SIDE == "AB"))
select_A1_ADAB <- as.logical((ACI1_final$TREAT == "A1") * (ACI1_final$SIDE == "ADAB"))

select_A2_AD <- as.logical((ACI1_final$TREAT == "A2") * (ACI1_final$SIDE == "AD"))
select_A2_AB <- as.logical((ACI1_final$TREAT == "A2") * (ACI1_final$SIDE == "AB"))
select_A2_ADAB <- as.logical((ACI1_final$TREAT == "A2") * (ACI1_final$SIDE == "ADAB"))
